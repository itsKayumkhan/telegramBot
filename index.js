...
const bot = new TelegramBot("7454719460:AAHaqbR2QL0W-9LTtmT3BJpR4mIONmOXLgc", {
  polling: true,
}); // TODO: Replace 'YOUR_TELEGRAM_BOT_TOKEN' with your actual bot token

mongoose
  .connect(
    "mongodb+srv://kayumkhan:kayumkhan2004@cluster0.ctdsalv.mongodb.net/telegram-bot",
    { useNewUrlParser: true, useUnifiedTopology: true }
  ) // TODO: Replace '<username>' and '<password>' with your MongoDB credentials
      ...
      const options = {
        reply_markup: {
          inline_keyboard: [
            ...
            [
              {
                text: "Join Gift Code Channel",
                url: "https://t.me/GIFTSAREAVERIFAID",
              },
            ], // TODO: Replace with your actual registration link
    ...
    switch (data) {
      case "withdraw":
        if (user.amount < 500) {
          bot.sendMessage(
            chatId,
            "You Need Minimum ₹500 In Balance To Withdraw !"
          );
        } else {
